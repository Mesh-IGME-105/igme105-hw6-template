...
namespace HW6_CritterFarm
{
    ...
    public class Program
    {
        ...
        static void RunCritterFarm()
        {
            ...
            //       so that it will create a file "critters.txt" in the same folder as
            //       the source code
           ...
           menuChoice = SmartConsole.Prompt(
            ...
            do
            {
                ...
                menuChoice = SmartConsole.Prompt(prompt, choices);
                ...
                switch (menuChoice)
                {
                    ...
                    case '1':
                        ...
                        while (!critterExists)
                        {
                            string userCritterChoice = SmartConsole.Prompt(">");
